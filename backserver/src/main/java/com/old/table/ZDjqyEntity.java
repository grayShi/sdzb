...
@Entity
@Table(name = "ZDjqy", schema = "dbo", catalog = "shaoxiongtest")
public class ZDjqyEntity {
    private int id;
    ...
    @Basic
    @Column(name = "ssyear", nullable = true, length = 4)
    ...
    public boolean equals(Object o) {
        ...
        ZDjqyEntity that = (ZDjqyEntity) o;
        ...
        if (ssyear != null ? !ssyear.equals(that.ssyear) : that.ssyear != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (ssyear != null ? ssyear.hashCode() : 0);
        return result;
    }
}
