    ...
    <div style="width: 95%">
      <light-table ref="table"
        ...
        <template slot="operateTable">
          <el-button @click="checkFee('checked')">核实</el-button>
          <el-button @click="checkFee('unChecked')">取消核实</el-button>
        </template>
      </light-table>
      <el-dialog
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="单位名称" prop="department">
                <el-select v-model="dialogForm.department" disabled clearable :placeholder="$placeholder.select">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="金额" prop="count">
                <el-input v-model="dialogForm.count" disabled :placeholder="$placeholder.input"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="收费项目" prop="feeProject">
                <el-select v-model="dialogForm.feeProject" disabled clearable :placeholder="$placeholder.select">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="收费方式" prop="feeWay">
                <el-select v-model="dialogForm.feeWay" disabled clearable :placeholder="$placeholder.select">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="发票号" prop="ticketNo">
                <el-input v-model="dialogForm.ticketNo" disabled :placeholder="$placeholder.input"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="是否到账" prop="whether">
                <el-select v-model="dialogForm.whether" disabled clearable :placeholder="$placeholder.select">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="收款单位" prop="feeDepartment">
                <el-select v-model="dialogForm.feeDepartment" disabled clearable :placeholder="$placeholder.select">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="科室" prop="section">
                <el-select v-model="dialogForm.section" disabled clearable :placeholder="$placeholder.select">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="备注" prop="more">
                <el-input v-model="dialogForm.more" disabled :placeholder="$placeholder.input"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
const changeFeeStatus = (id) => axios.put('api/fee/verify', id);
const cancelFeeStatus = (id) => axios.put('api/fee/cancel_verify', id);
  ...
  methods: {
    ...
    checkFee (status) {
      if (this.selectRow.length === 0) {
        ...
        let checkFunction;
        if (status === 'checked') {
          if (this.selectWhetherRow.length !== this.selectRow.length) {
            this.onAlertError('未到账不能核实');
            return;
          }
          checkFunction = changeFeeStatus;
        } else {
          checkFunction = cancelFeeStatus;
        }
        checkFunction({id: this.selectRow}).then(data => {
          this.loading = false;
          if (data.data.code === '000') {
            this.loading = false;
            this.onAlertSuccess('核实成功');
            this.$refs.table.doRemoteMethod();
          }
        });
      }
