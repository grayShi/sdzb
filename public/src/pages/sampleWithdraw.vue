  ...
  <page-main-body title="样品退样">
    <light-table ref="table"
      ...
      <template slot="edit" slot-scope="props">
        <div>
          <el-button size="mini" type="primary" @click="sampleWithdraw(props.prop)">样品退样</el-button>
          <el-button size="mini" style='margin-left: auto' type="info" @click="viewList(props.prop)">退样记录</el-button>
        </div>
      </template>
    </light-table>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="样品状态" prop="sampleStatus">
              <el-input v-model="dialogForm.sampleStatus" :disabled="!dialogForm.isDelete"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  export default {
    ...
    methods: {
      ...
      sampleWithdraw(prop){
        ...
        this.dialogForm.title = '样品退样';
      },
      onSubmit(){
        this.showDialog = false;
        getSampleDataList(this.id, {opDate:this.dialogForm.opDate, opPlace:this.dialogForm.opPlace,opCount:this.dialogForm.opCount, opType:"withdraw",opUser:this.dialogForm.opUser}).then(result =>{
          this.loading = false;
